...
if ( isset( $_POST['email'] ) ):
    ...
    $to_email = "contato@marceloribeiropatisserie.com.br";    // provide your target email address here
    $to_name = "Contato do Site";
    ...
    $email_body = 	"You have Received a message from: " . $name . " <br/>"
                ...
                . "Their additional message is as follows." . " <br/><br/>" ;
